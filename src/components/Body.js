...
function Body() {
    ...
    return (
        <ParallaxProvider>
            ...
            <Stars/>
            {songs.length != 0 && (
                songs.map((song, ind) => <Song x={ind % 2 == 0 ? 100 : 1000} y={650*(ind+1)} iconSize={200} noteSize={300} songName="Willow" artistName="Taylor Swift" albumArtLink="https://media.pitchfork.com/photos/5f1e2abad421092dd8f6c7ca/1:1/w_320/Taylor_Swift_folklore.jpeg" rowId={song.id} initialNotes={song.notes}/>)
            )}
